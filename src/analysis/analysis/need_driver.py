...
POLICY_MAP = {
    "suicide_rate": [
        "고위험군 조기발견(게이트키퍼/위기신호 모니터링) + 즉시연계 체계 강화",
        "위기상담 접근성(야간/주말) 확장 + 응급연계(정신응급/119/병원) 프로토콜 정교화",
    ],
    "depression_experience_rate": [
    ...
    "high_risk_drinking_rate": [
        "고위험 음주군 대상 단기개입(SBIRT) + 중독상담 연계",
        "야간·회식문화 밀집 권역 중심 예방 캠페인 + 상담 접근성 강화",
    ],
    "unmet_medical_need_rate": [
    ...
    "basic_livelihood_recipients": [
        "경제취약층 대상 마음건강+복지 원스톱 연계(상담→지원제도 연결)",
        "주거·생계 불안 완화 지원과 정신건강 서비스 동시 제공(케이스관리)",
    ],
}
